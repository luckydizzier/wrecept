...
{
    /// <inheritdoc />
    public partial class ExpandDomainProps : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGross = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsArchived = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    Net = table.Column<decimal>(type: "TEXT", nullable: false),
                    Gross = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxRates_Code_IsArchived",
                table: "TaxRates",
                columns: new[] { "Code", "IsArchived" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Units_Code_IsArchived",
                table: "Units",
                columns: new[] { "Code", "IsArchived" });

            migrationBuilder.CreateIndex(
                name: "IX_Units_Name_IsArchived",
                table: "Units",
